...
@Component
@Slf4j
public class VisualizerRouteHandler {

  private final ResourceLoader resourceLoader;
  private final String staticContent;

  private static final String INDEX_LOCATION = String.format("classpath:visualizer.html");
  public static final String SUCCESS_MSG = "Serving visualizer.html page";
  public static final String ERROR_MSG = "Could not find 'visualizer.html' for serving Graphiql Visualizer";

  public VisualizerRouteHandler(ResourceLoader resourceLoader) throws IOException {
